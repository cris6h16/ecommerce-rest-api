...
class UserServiceImpl implements UserService {
    ...
    UserServiceImpl(UserRepository userRepository, UserValidator userValidator, ErrorMessagesProperties errorMessagesProperties, PasswordEncoder passwordEncoder) {
